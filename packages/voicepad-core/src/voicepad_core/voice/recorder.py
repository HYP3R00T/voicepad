...
from voicepad_core.voice.utils import get_recording_path
...
def record_voice(
    ...
    Args:
        ...
        output_dir: Directory where recording will be saved.
        prefix: Filename prefix for the recording.

    Returns:
        Path to the recorded file.
    """
    output_dir.mkdir(parents=True, exist_ok=True)
    output_path = get_recording_path(output_dir, prefix)
