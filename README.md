...
Read [CONTRIBUTING.md](CONTRIBUTING.md) before proposing substantial work. Trusted checkouts include a manually invoked `issue-to-pr` skill for Agent Skills-compatible coding agents. Report suspected vulnerabilities privately by following [SECURITY.md](SECURITY.md), not through a public issue.
